export default function Homethree() {
  return (
    <>
      <div className="w-full my-10 p-10 flex justify-center items-center bg-[url('/images/back2.jpg')] ">
        <div className="main w-[85%] flex gap-20">
          <div className="left w-1/2 p-5">
            ...
            <button className="btn-blue text-sm pr-6 pl-6 font-semibold flex items-center border-[1px] rounded border-blue-500 p-3 hover:bg-blue-500 text-blue-500 hover:text-white">
              VIEW ALL SERVICES
              <svg
