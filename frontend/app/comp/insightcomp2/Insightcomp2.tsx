...
const Insightcomp2card: React.FC<Bloog> = ({ title, linkt }) => {
  return (
    <div className="bg-stone-200 shadow-md hover:scale-105 ease-in-out duration-300 shadow-gray-300 w-[295px] md:w-[300px]">
      <img
        src={linkt}
        alt="ele"
        ...
        height={100}
      />
      <div className="font-semibold m-3 line-clamp-2">{title}</div>
