  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col items-center relative">
        <Image
          src={img1}
          className="w-[100vw] h-[20rem] object-cover opacity-15"
          alt=""
        />
        <div className="flex justify-between items-center w-[70%] absolute top-28">
          <div className="text-5xl font-semibold text-gray-600 w-[35rem]">
