...
export default function Page() {
  let str =
    "The electric and hybrid vehicles sector is experiencing significant growth and innovation. Explore more about the latest trends, market projections, and technological advancements in electric and hybrid vehicles.";
